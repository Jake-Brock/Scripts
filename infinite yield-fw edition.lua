...
Title.TextSize = 18
Title.Text = "Infinite Yield - Frostware edition v" .. currentVersion
...
Credits.Text = "Jake // Zwolf // Moon // Toon // Peyton // ATP"
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated client!", "get the latest Frostware edition infinite yield at https://getfrosts.xyz/scripts")
		end
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Frostware", "welcome to infinite yield Frostware Edition.") end
end)